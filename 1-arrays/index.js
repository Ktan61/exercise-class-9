 ...
 * Question 4
 * 
 * initialise the variable `schedule` to a 2-Dimensional array containing the 
 * values below:
 * 
 ...
 * 
 * Then based on the values stored in the schedule 2D array, console log out 
 * the following sentence (use backticks):
